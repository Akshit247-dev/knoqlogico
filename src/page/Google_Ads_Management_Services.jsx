...
import "./Google_Ads_Management_Services.css"
import googleAdsImage from '../assets/img/Google-Ads-Management-Services.svg';
import { Link } from "react-router-dom";

function Google_Ads_Management_Services() {
  return (
    <>
    <Header/>
  {/* MAIN----------------------- */}
  <div className="Google-Ads-Management-Services-main">
    <div className="Google-Ads-Management-Services-main-blue-cover" />
    <div className="Google-Ads-Management-Services-content">
      ...
      <ul>
        ...
        <li>What we do</li>
        <li>&gt;</li>
        <li>Google Ads Management Services</li>
      </ul>
    </div>
  </div>
  {/* TAGLINE-------------------- */}
  <div className="Google-Ads-Management-Services-tagline-section">
    <h2>Google Ads Management Services</h2>
    <div className="Google-Ads-Management-Services-beat-img" />
    <p>
  ...
  {/* HERO SECTION-------------- */}
  <div className="Google-Ads-Management-Services-hero-section">
    <div className="Google-Ads-Management-Services-hero-img">
    <img src={googleAdsImage} alt="Google Ads Management Services" />
    </div>
    <div className="Google-Ads-Management-Services-hero-content">
      <p className="Google-Ads-Management-Services-hero-techie">Our Marketing Expert</p>
      <h3>Google Ads Management Services</h3>
      <div className="Google-Ads-Management-Services-hero-conent-para">
        <p>
      ...
      <div className="Google-Ads-Management-Services-hero-button">
      <Link to="/Contact">Contact Us</Link>
      </div>
    </div>
  </div>
  {/* CARDS - PROCESS------------------ */}
  <div className="Google-Ads-Management-Services-ag-format-container">
    <div className="Google-Ads-Management-Services-ag-courses_box">
      <div className="Google-Ads-Management-Services-ag-courses_item">
        <a href="#" className="Google-Ads-Management-Services-ag-courses-item_link">
          <div className="Google-Ads-Management-Services-ag-courses-item_bg" />
          <div className="Google-Ads-Management-Services-ag-courses-item_title">1. Technical SEO Review</div>
          <div className="Google-Ads-Management-Services-ag-courses-item_date-box">
      ...
      <div className="Google-Ads-Management-Services-ag-courses_item">
        <a href="#" className="Google-Ads-Management-Services-ag-courses-item_link">
          <div className="Google-Ads-Management-Services-ag-courses-item_bg" />
          <div className="Google-Ads-Management-Services-ag-courses-item_title">2. Competitor Analysis</div>
          <div className="Google-Ads-Management-Services-ag-courses-item_date-box">
      ...
      <div className="Google-Ads-Management-Services-ag-courses_item">
        <a href="#" className="Google-Ads-Management-Services-ag-courses-item_link">
          <div className="Google-Ads-Management-Services-ag-courses-item_bg" />
          <div className="Google-Ads-Management-Services-ag-courses-item_title">3. Meta Data Analysis</div>
          <div className="Google-Ads-Management-Services-ag-courses-item_date-box">
      ...
      <div className="Google-Ads-Management-Services-ag-courses_item">
        <a href="#" className="Google-Ads-Management-Services-ag-courses-item_link">
          <div className="Google-Ads-Management-Services-ag-courses-item_bg" />
          <div className="Google-Ads-Management-Services-ag-courses-item_title">4. Image Optimization</div>
          <div className="Google-Ads-Management-Services-ag-courses-item_date-box">
      ...
      <div className="Google-Ads-Management-Services-ag-courses_item">
        <a href="#" className="Google-Ads-Management-Services-ag-courses-item_link">
          <div className="Google-Ads-Management-Services-ag-courses-item_bg" />
          <div className="Google-Ads-Management-Services-ag-courses-item_title">5. Speed Optimization </div>
          <div className="Google-Ads-Management-Services-ag-courses-item_date-box">
      ...
      <div className="Google-Ads-Management-Services-ag-courses_item">
        <a href="#" className="Google-Ads-Management-Services-ag-courses-item_link">
          <div className="Google-Ads-Management-Services-ag-courses-item_bg" />
          <div className="Google-Ads-Management-Services-ag-courses-item_title">6. Keyword Research</div>
          <div className="Google-Ads-Management-Services-ag-courses-item_date-box">
...
export default Google_Ads_Management_Services