  ...
  return (
    ...
    <div className="Iot-hero-section">
      ...
      <div className="Iot-hero-content">
        ...
        <div className="Iot-hero-conent-para">
          <p>
            Our IoT training program gives you the knowledge and skills to design,
            develop, and implement IoT solutions across industries. Learn to
            integrate sensors, work with data, and build scalable IoT systems that
    ...
    <div className="Iot-robotics-cards-section">
      ...
      <div className="Iot-cards-container">
        ...
        <div className="Iot-training-card">
          <img src="./18705.jpg" alt="Expert Mentors" className="Iot-card-image" />
          <div className="Iot-card-content">
    ...
    <div className="Iot-learning-journey">
      <h2 className="Iot-journey-heading">Start Your Learning Journey Today!</h2>
      ...
      <a href="contact.html" className="Iot-journey-button">
        Enroll Now
      </a>
    </div>
    <Footer/>
